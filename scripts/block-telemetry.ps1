<#
TODO:
Add in Write progress 1/4 - fix this
Test declarations included in begin.
#>
...
process {
    ...
    Write-Progress -Activity "Disabling telemetry via Group Policies" `
    ...
    $PercentComplete = ($PercentComplete + 25)
    Write-Progress -Activity "Adding telemetry domains to hosts file" `
                   -PercentComplete  $PercentComplete `
                   -CurrentOperation "$PercentComplete% Complete" `
                   -Status "Please Wait..."
    ...
    $PercentComplete = ($PercentComplete + 25)
    Write-Progress -Activity "Adding telemetry ips to firewall" `
                   -PercentComplete  $PercentComplete `
                   -CurrentOperation "$PercentComplete% Complete" `
                   -Status "Please Wait..."
    <#
